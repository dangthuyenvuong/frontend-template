            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-12">
                        {/* Slider */}
                        <div data-flickity="{&quot;pageDots&quot;: true}" className="flickity-enabled is-draggable" tabIndex={0}>
                            <div className="flickity-viewport" style={{ height: '374.8px', touchAction: 'pan-y' }}><div className="flickity-slider" style={{ left: '0px', transform: 'translateX(-133.33%)' }}><div className="col-12 col-sm-8 col-md-6 col-lg-4 is-selected" style={{ position: 'absolute', left: '133.33%' }}>
                                {/* Card */}
                            ...
                            </div><div className="col-12 col-sm-8 col-md-6 col-lg-4" aria-hidden="true" style={{ position: 'absolute', left: '166.66%' }}>
                                    {/* Card */}
                                    <div className="card-lg card border">
                                        <div className="card-body">
                                            {/* Header */}
                                ...
                                </div><div className="col-12 col-sm-8 col-md-6 col-lg-4" aria-hidden="true" style={{ position: 'absolute', left: '199.99%' }}>
                                    {/* Card */}
                                    <div className="card-lg card border">
                                        <div className="card-body">
                                            {/* Header */}
                                ...
                                </div><div className="col-12 col-sm-8 col-md-6 col-lg-4" aria-hidden="true" style={{ position: 'absolute', left: '233.33%' }}>
                                    {/* Card */}
                                    <div className="card-lg card border">
                                        <div className="card-body">
                                            {/* Header */}
                                ...
                                </div></div></div><ol className="flickity-page-dots"><li className="dot is-selected" aria-label="Page dot 1" aria-current="step" /><li className="dot" aria-label="Page dot 2" /><li className="dot" aria-label="Page dot 3" /><li className="dot" aria-label="Page dot 4" /></ol></div>
                    </div>
                </div>
            </div>
        </section>
